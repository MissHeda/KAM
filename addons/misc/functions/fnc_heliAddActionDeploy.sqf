...
_h addAction [
  format ["<img image='x\kat\addons\misc\ui\downarrow.paa' size='1' shadow='false'/> <t>%1</t>", LLSTRING(helistretcher_lower)],
  {
    ...
    _s addAction [
      format ["<img image='x\kat\addons\misc\ui\fliparrow.paa' size='1' shadow='false'/> <t>%1</t>", LLSTRING(helistretcher_flip)],
      {
        params ["_target", "_caller", "_actionId", "_arguments"];
